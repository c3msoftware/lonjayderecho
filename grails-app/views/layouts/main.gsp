...
<body>
							...
							<ul class="dropdown-menu">
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#"> <i class="fa fa-users warning"></i>
										...
										<li><a href="#"> <i
												class="ion ion-ios7-person danger"></i> You changed your
												username
										</a></li>
									</ul>
								</li>
	...
	<!-- Sparkline -->
	<asset:javascript src="plugins/sparkline/jquery.sparkline.min.j" />
	<!-- jvectormap -->
...
>>>>>>> branch 'master' of https://github.com/c3msoftware/lonjayderecho.git
</body>
</html>
